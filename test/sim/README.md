...
- `test/balance.mjs` — Registered balance harness that sweeps build times 18/24/28/34/45/60 seconds across three seeds in both regular and training modes, reporting served, lost split by walk-out versus queue-abandon, money, tips, rep, rank, and end time. Re-run after changing patience, flight sizes, trickle interval, or queue tolerance.
